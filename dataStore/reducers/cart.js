import { SET_LOAD_CART_PROCESS, SET_LOAD_CART_DATA, SET_LOAD_CART_STATUS, RESET_DATA, SET_CHARGES, ADD_NEW_CART, UPDATE_CART, DEL_CART_ITEM, CLEAR_CART } from "../types/types";
const initialData = {
    cartprocess: false,
    cartStatus: '',
    cartData: [],
